...
namespace logger
{
    ...
    template <> struct log_util<char>
    {
        ...
        static std::string format_line(
            char const *time_buffer, level level, log_context const &context, char const *msg, const types... args)
        {
        ...
        template <typename... types>
        static std::string format_line_ansi(
            char const *time_buffer, level level, log_context const &context, char const *msg, const types... args)
        {
            std::string message = std::vformat(msg, std::make_format_args(args...));
    ...
    template <> struct log_util<wchar_t>
    {
        ...
        template <typename... types>
        static std::wstring format_line_ansi(wchar_t const *time_buffer,
                                             level level,
                                             log_context const &context,
                                             wchar_t const *msg,
                                             const types... args)
        {
        ...
        template <typename... types>
        static std::wstring format_line(wchar_t const *time_buffer,
                                        level level,
                                        log_context const &context,
                                        wchar_t const *msg,
                                        const types... args)
